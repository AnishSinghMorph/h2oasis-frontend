  ...
  return () => clearTimeout(timer);
    ...
    return (
        <View style={globalStyles.container}>
            ...
            <ImageBackground source={require('../../assets/person.png')} style={landingStyles.backgroundImage} resizeMode='cover'>
                <View style={landingStyles.overlay}>
                    <View style={landingStyles.logoSection}>
                        <Image source={require('../../assets/logo.png')} style={landingStyles.logo} resizeMode='contain'/>
